...
\begin{minipage}[t]{.4\textwidth}
	...
	\vspace*{1em}
	\textbf{PTA GmbH} \\
	Herr Matthias Wossidlo\\[.35ex]
	% }}
	\small%
	Seckenheimstraße 65-67\\
	68165 Mannheim
\end{minipage}
%
\hfill
...
{\bfseries \color{familynamecolor}Berater im Projektmanagement -- Kennziffer stp\_H\_2015}\\[0.75em]

Sehr geehrter Herr Wossidlo,\\[0.5em]
%

ich bewerbe mich bei der PTA GmbH als Unternehmensberater.
...
Aus persönlichem Interesse beschäftige ich mich seit vielen Jahren mit Open-Source Software, insbesondere Linux. Diesbezügliche Kenntnisse habe ich mir durch Selbststudium und meine ehrenamtliche Arbeit im Verein Berlin Linux Group als Vorstandsmitglied angeeignet.
