...
\def\FileTitle{\firstname~\familyname's Vortrag zu Energiepolitik im Baltikum}
\def\FileSubject{Energiepolitik im Baltikum}
\def\FileKeyWords{\firstname~\familyname, Vortrag zu Energiepolitik im Baltikum}
...
\definecolor{Violet}{RGB}{142,121,165}
...
\item der Gassektor kann in die drei Segmente \textbf{Upstream} -- \textbf{Midstream} -- \textbf{Downstream} gegliedert werden
	...
	\ding{225} geographisch gebundene Geschäftsaktivität, die häufig in einem Spannungsverhältnis mit Souveränitätsansprüchen von Nationalstaaten steht (meist sind Staatsunternehmen in diesem Bereich tätig: \textsl{Gazprom})\\
...
\paragraph{\color{Orange}{\textsf{Energiemarkt Lettland}}} 
...
\item starke russische Beteiligungen im lettischen Energiesektor: Öltransport, Gasunternehmen
	...
	\ding{225} allerdings bestimmt die russisch-beeinflusste \emph{Latvijas G\={a}ze} über die Verwendung des gespeicherten Gases
...
\paragraph{\color{Orange}{\textsf{Energiemarkt Litauen}}}
...
\ding{225} keine Anbindung an Stromnetze der EU über Polen\\
\ding{225} in Zukunft wird Litauen Strom aus der russischen Region Kaliningrad vom dort im Bau befindlichen Atomkraftwerk \textsl{Baltiskaya} beziehen
...
\ding{225} der westliche Anteilseigner an \emph{Lietuvos dujos} und \emph{Lativjas G\={a}ze} ist die \emph{E.ON Ruhrgas AG}, die traditionell gute Beziehungen zu ihren russischen Geschäftspartnern unterhält und Interesse an enger Kooperation mit Russland hat
